...
export default function FacebookFeed({ lang }: FacebookFeedProps) {
  ...
  useEffect(() => {
    ...
    script.src =
      'https://cdn.curator.io/published/aff7b61e-cce9-47ab-9ab9-73dc8cbe687d.js';
    document.body.appendChild(script);
  }, []);
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 h-72 w-[36rem] rounded-full bg-orange-200/30 blur-3xl dark:bg-orange-500/10"
      />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h3 className="text-xl sm:text-2xl font-sans font-bold tracking-tight text-text-primary whitespace-nowrap">
              Follow Our Journey
            </h3>
            <span className="h-px flex-1 bg-border-primary" />
          </div>
